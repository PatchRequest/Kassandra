...
impl OutputCollector {
    pub const fn new() -> OutputCollector {
        OutputCollector {
            output: Vec::new(),
            offset: 0,
        }
...
static mut OUTPUT: OutputCollector = OutputCollector::new();
...
#[no_mangle]
#[allow(static_mut_refs)]
pub extern "C" fn beacon_get_output_data() -> &'static mut OutputCollector {
    unsafe { &mut OUTPUT }
}
